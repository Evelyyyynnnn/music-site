...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || ' We Enjoy the World🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'We Enjoy the World', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://evelyn-music-site.vercel.app/?theme=matery', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Evelyyyynnnn/', // 你的github个人主页 例如 https://github.com/tangly1024
